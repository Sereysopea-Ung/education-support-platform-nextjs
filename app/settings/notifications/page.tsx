...
export default function NotificationPage() {
  ...
  return (
    <div className="grid grid-cols-12 h-full w-full">
      <div className="bg-white p-4 lg:ml-130 md:ml-60 sm:ml-40 shadow-md lg:w-[850px] md:w-[600px] sm:w-[480px] text-gray-500">
        {/* Header */}
        <div className="flex items-center justify-between mb-10">
            {/* Title */}
            <h1 className="text-[30px] font-semibold px-5 -mt-2 mb-4">Notification</h1>
        ...
        <section className="px-5">
          <h2 className="flex items-center gap-2 text-[20px] mb-3">
