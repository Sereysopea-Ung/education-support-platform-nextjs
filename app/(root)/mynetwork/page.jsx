...
const PEOPLE = [
  { id: 1, name: "Liu Xue Yi", role: "Software Engineer", year: 4, mutual: true },
  { id: 2, name: "P Diddy", role: "Data Science", year: 2, mutual: false },
  { id: 3, name: "P Diddy", role: "Data Science", year: 2, mutual: false },
  { id: 4, name: "P Diddy", role: "Data Science", year: 2, mutual: false },
];

function SearchIcon() {
  return (
    
  <div className="mt-1.5 mr-5 px-2 py-2 rounded-full hover:bg-blue-100">
...
function Pill({ active, children, onClick }) {
  return (
    <button
      onClick={onClick}
      className={[
        "ml-3 h-9 rounded-md border-2 px-3 text-[18px]",
...
function PersonCard({ p }) {
  ...
  return (
    <article className="flex items-center gap-3 rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
      <div className="grid h-13 w-13 flex-none place-items-center rounded-full bg-gray-100 text-[18px] font-bold text-center text-gray-900">
        <img
      ...
      <div>
        <div className="text-[20px] text-gray-900">{p.name}</div>
        <div className="text-[16px] text-gray-500">
          {p.role} <span className="mx-2 text-gray-300">•</span> Year {p.year}
        </div>
      </div>
    </article>
  );
...
export default function MyNetworkPage() {
  ...
  const filtered = useMemo(() => {
    ...
    return PEOPLE.filter((p) => {
      ...
      const matchesSeg = seg === "all" || p.mutual;
      ...
      <div className="mx-auto w-full">
            ...
            {/* logo  */}
              ...
              <div className="position-absolute w-full -mt-[60px] rounded-t-2xl shadow-2xs bg-white h-full">
                ...
                <ul className="flex flex-col gap-y-4 mt-18 ml-5">
                  ...
                  <li className={`p-2  hover:cursor-pointer ${activeMenu === "My Network" ? "bg-blue-600 px-2 py-4 text-white rounded-[10px]" : ""}`}>
                    <span className="flex items-center gap-x-5" onClick={() => setActiveMenu("My Network")}>
                      <svg
                        width="30"
                        height="30"
                        viewBox="0 0 20 19"
                  ...
                  <li className="p-2  hover:cursor-pointer">
                    <span className="flex items-center gap-x-5" onClick={() => router.push("/collection")}>
                      <svg
                        width="30"
                        height="30"
                        viewBox="0 0 20 20"
                  ...
                  <li className="p-2  hover:cursor-pointer" onClick={() => router.push("/opportunity")}>
        ...
        <div className="ml-115">
          ...
          <div className="bg-white -ml-8">
            <div className="flex items-center gap-x-[1100px] h-[100px] w-full">
                <h1 className="text-4xl font-semibold text-gray-900 ml-10">Following</h1>
                <div className="justify-self-end text-[16px] text-gray-500">
          ...
          <div className="mt-5 flex items-center gap-3">
                <div className="relative w-full max-w-[420px]">
                  <input
                    ...
                    className="h-13 w-full rounded-lg border border-gray-200 bg-white pl-3 pr-10 text-[14px] outline-none placeholder:text-gray-400"
                  />
                  <button
                    aria-label="Search"
                    className="absolute right-1 top-1 grid h-8 w-8 place-items-center"
                  >
                    <SearchIcon className="ml-1 border-1 border-transparent w-[15em] h-[2.5em] pl-[0.8em] outline-1 overflow-hidden bg-[#ffffff] rounded-[10px] transition-all duration-500 hover:border-[#7e8387] focus:border-[#7e8387] hover:shadow-[0_0_0_2px_rgba(74,157,236,0.2)] focus:shadow-[0_0_0_2px_rgba(74,157,236,0.2)] hover:bg-white focus:bg-white" />
                  </button>
                </div>
                <div className="flex gap-2 ">
                  <Pill active={seg === "all"} onClick={() => setSeg("all")}>
                    All
                  </Pill>
                  <Pill active={seg === "mutual"} onClick={() => setSeg("mutual")}>
                    Mutual Connections
                  </Pill>
                </div>
          </div>
          ...
          {/* Divider */}
          <div className="-mx-5 ml-1 mt-4 w-full h-px bg-gray-200" />

          {/* Cards */}
          <section className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 w-[90%]">
            {filtered.map((p) => (
